...
e. The confidence interval is nearly exactly the same as that calculated in 8.21. The probabilty that lambda<1 is a bit lower in the approximation (0.014) than it was based on the posterior model estimate (0.06).
...
bb_chains_df <- bb_chains_df %>% 
  mutate(y_predict = rgamma(n=length(lambda), shape=lambda))
...
b. The number of birds a birdwatcher will most likely observe in their next watching period is...
